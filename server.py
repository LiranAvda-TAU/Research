...
class HomologyHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        orthologs_format_reminder = "for orthologs: ipNumber:8080/Orthologs;NameOfHumanGene, for example: http://http://132.66.207.99:8080/Orthologs;TCP1;ZO1 <br />"
        variants_format_reminder = "for variants: ipNumber:8080/Variants;NameOfHumanGene:[variant1, variant2], for example: http:/http://132.66.207.99:8080/Variants;TCP1:[Asn284Ser,Ala453Glu],DAP3:[Leu138Phe,Glu369Lys]"
